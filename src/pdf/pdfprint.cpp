...
wxPdfPrintDialog::Init(wxWindow * WXUNUSED(parent)) {
    ...
    if (dialogFlags & wxPDF_PRINTDIALOG_PROTECTION) {
        ...
        m_userpwdconfirm = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize,
                                          wxTE_PASSWORD);
        ...
        flex3->Add(new wxStaticText(this, wxID_ANY, _("Confirm")), 0, wxALL, 5);
        m_ownerpwdconfirm = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize,
                                           wxTE_PASSWORD);
...
wxPdfPageSetupDialog::Init() {
    ...
    if (m_pageData.GetEnableMargins()) {
        ...
        m_marginLeftText = new wxTextCtrl(this, wxPDF_PAGEDIALOG_CTRLID_MARGINLEFT, wxEmptyString, wxDefaultPosition,
                                          wxSize(50, -1));
        ...
        m_marginTopText = new wxTextCtrl(this, wxPDF_PAGEDIALOG_CTRLID_MARGINTOP, wxEmptyString, wxDefaultPosition,
                                         wxSize(50, -1));
        ...
        m_marginRightText = new wxTextCtrl(this, wxPDF_PAGEDIALOG_CTRLID_MARGINRIGHT, wxEmptyString, wxDefaultPosition,
                                           wxSize(50, -1));
        ...
        m_marginBottomText = new wxTextCtrl(this, wxPDF_PAGEDIALOG_CTRLID_MARGINBOTTOM, wxEmptyString,
