...
wxString
wxPdfFontDataType1::GetWidthsAsString(bool subset, wxPdfSortedArrayInt *usedGlyphs,
                                      wxPdfChar2GlyphMap *subsetGlyphs) const {
    wxUnusedVar(subset);
    wxUnusedVar(usedGlyphs);
    wxUnusedVar(subsetGlyphs);
...
wxString
wxPdfFontDataType1::GetWidthsAsString(const wxArrayString &glyphNames, bool subset, wxPdfSortedArrayInt *usedGlyphs,
                                      wxPdfChar2GlyphMap *subsetGlyphs) const {
    wxUnusedVar(subset);
    wxUnusedVar(usedGlyphs);
    wxUnusedVar(subsetGlyphs);
...
size_t
wxPdfFontDataType1::WriteFontData(wxOutputStream *fontData, wxPdfSortedArrayInt *usedGlyphs,
