...
bool QuadContourGenerator::is_edge_a_boundary(const QuadEdge& quad_edge) const
{
    ...
    switch (quad_edge.edge) {
	case Edge_E:  return BOUNDARY_E(quad_edge.quad) ? true : false;
        case Edge_N:  return BOUNDARY_N(quad_edge.quad) ? true : false;
        case Edge_W:  return BOUNDARY_W(quad_edge.quad) ? true : false;
        case Edge_S:  return BOUNDARY_S(quad_edge.quad) ? true : false;
