...
wxPdfDocument can simply load the .otf or .ttf files directly.  No need to preprocess them using the procedure below.

Added LindenHill, RalewayThin, and LeagueScriptNumberOne from:

https://www.theleagueofmoveabletype.com/

The Open Font License (OFL), is a license we like here at The League of Moveable Type, because it’s the only open-source license specifically designed for fonts. It may seem a bit like legalese (and it sort of is – one of the goals of it’s creators was to make sure the license was legally sound), it has an answer to almost all the questions you can imagine for an open-source font.
