...
WX_DECLARE_HASH_MAP_WITH_DECL(long, wxPdfObjectQueue*, wxIntegerHash, wxIntegerEqual, wxPdfObjectMap,
                              class WXDLLIMPEXP_PDFDOC);

/// Hashmap class for object queue entries (For internal use only)
WX_DECLARE_HASH_MAP_WITH_DECL(long, wxPdfObject*, wxIntegerHash, wxIntegerEqual, wxPdfObjStmMap,
                              class WXDLLIMPEXP_PDFDOC);
