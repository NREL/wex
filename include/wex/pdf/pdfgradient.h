...
public:
    ...
    */
    wxPdfAxialGradient(const wxPdfColour &colour1, const wxPdfColour &colour2, double x1, double y1, double x2,
                       double y2, double intexp);
...
public:
    ...
    * \param intexp interpolation exponent
    */
    wxPdfMidAxialGradient(const wxPdfColour &colour1, const wxPdfColour &colour2, double x1, double y1, double x2,
                          double y2, double midpoint, double intexp);
...
public:
    ...
    * \param intexp interpolation exponent
    */
    wxPdfRadialGradient(const wxPdfColour &colour1, const wxPdfColour &colour2, double x1, double y1, double r1,
