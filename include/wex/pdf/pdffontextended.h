...
public:
    ...
    */
    wxString GetWidthsAsString(bool subset = false, wxPdfSortedArrayInt *usedGlyphs = NULL,
    ...
    */
    wxString
    ConvertCID2GID(const wxString &s, wxPdfSortedArrayInt *usedGlyphs = NULL, wxPdfChar2GlyphMap *subsetGlyphs = NULL);
    ...
    */
    wxString
    ConvertGlyph(wxUint32 glyph, wxPdfSortedArrayInt *usedGlyphs = NULL, wxPdfChar2GlyphMap *subsetGlyphs = NULL);
